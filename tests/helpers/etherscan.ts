...
export const ETHERSCAN_CHAINS: Set<number> = new Set([
  1, 11155111, 17000, 560048, 56, 97, 137, 80002, 1101, 2442, 8453, 84532, 42161, 42170, 421614, 59144, 59141, 250,
  4002, 81457, 168587773, 10, 11155420, 43114, 43113, 199, 1028, 42220, 44787, 25, 252, 2522, 100, 255, 2358, 5000,
  5003, 1284, 1285, 1287, 204, 5611, 534352, 534351, 167000, 167009, 1111, 1112, 324, 300, 660279, 37714555429, 50, 51,
 ...
 */
export function getEtherscanContractCreationUrl(params: { chainId: number; contractAddresses: string }): string {
