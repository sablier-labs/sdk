...
// Get chain by ID
const arbitrum = sablier.evmChains.get(42161);

// Get chain by slug
const polygon = sablier.evmChains.getBySlug("polygon");
...
const lockup = sablier.evmContracts.get({
...
const allLockups = sablier.evmReleases.getAll({ protocol: "lockup" });
```
