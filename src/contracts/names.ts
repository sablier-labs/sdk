...
import airdropsV2_0 from "@src/releases/airdrops/v2.0/manifest";
import flowV1_0 from "@src/releases/flow/v1.0/manifest";
import flowV1_1 from "@src/releases/flow/v1.1/manifest";
import flowV2_0 from "@src/releases/flow/v2.0/manifest";
...
import lockupV3_0 from "@src/releases/lockup/v3.0/manifest";
