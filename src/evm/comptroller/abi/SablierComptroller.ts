export const sablierComptrollerAbi = [
  ...
  {
    inputs: [],
    name: "SablierComptroller_ExecutionFailedSilently",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: "SablierComptroller_FeeRecipientZero",
    type: "error",
  },
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "initialAirdropMinFeeUSD",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "initialFlowMinFeeUSD",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "initialLockupMinFeeUSD",
        type: "uint256",
      },
      {
        internalType: "address",
