export const sablierMerkleLLAbi = [
  ...
  {
    inputs: [],
    name: "VESTING_CLIFF_UNLOCK_PERCENTAGE",
    outputs: [
      {
        internalType: "UD60x18",
        name: "",
  ...
  {
    inputs: [],
    name: "VESTING_START_UNLOCK_PERCENTAGE",
    outputs: [
      {
        internalType: "UD60x18",
        name: "",
  ...
  {
    inputs: [],
    name: "SablierMerkleBase_InvalidSignature",
    type: "error",
  },
  {
    inputs: [
  ...
  },
  {
    ...
    name: "SablierMerkleBase_SignatureNotYetValid",
    type: "error",
  },
  {
    inputs: [],
    name: "SablierMerkleBase_ToZeroAddress",
    type: "error",
  },
  {
    inputs: [
