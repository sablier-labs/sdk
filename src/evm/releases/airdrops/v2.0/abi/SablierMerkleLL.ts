export const sablierMerkleLLAbi = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "UD60x18", name: "cliffUnlockPercentage", type: "uint256" },
          ...
          { internalType: "UD60x18", name: "startUnlockPercentage", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "viaSig", type: "bool" },
    ],
  ...
  { inputs: [], name: "SablierMerkleBase_InvalidSignature", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "SablierMerkleBase_ToZeroAddress", type: "error" },
  {
