...
export const mainnets: Sablier.EVM.Deployment[] = [
  get(chains.abstract.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x15C9d45FB210B11cF5fD16C35ed3C31D7ca475Cb", 20333279],
  ...
  get(chains.arbitrum.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x4273c32a668ee9d8b24c4d774635134c72974077", 384587456],
    ...
    [manifest.SABLIER_FACTORY_MERKLE_VCA]: ["0x199de153773ac81494978d7b313e7402d2fa2425", 384587468],
  }),
  get(chains.avalanche.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x25df49158cd5d9fc9def1dae57cf891310d6bfa0", 69539847],
  ...
  get(chains.base.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x4b2aa7e2a47b5cfd67a4943de2952d0f4ca683cd", 36223040],
  ...
  get(chains.berachain.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xc4ca662dce3a32ee3b592c0af35013d5ff8d6738", 11163598],
  ...
  get(chains.blast.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xc880032820f62d3fbc48bc56890ee774c3741b69", 25213122],
  ...
  get(chains.bsc.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xd3195b706056349e8b371150220bf95cc6fb098b", 62982924],
  ...
  get(chains.chiliz.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x197d5bad8e769ddba86ed4adcc2f467b82364874", 27498599],
  ...
  get(chains.coreDao.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xcd7606fddbf113f7d35081950a65abd6ad2f7d84", 28645207],
  ...
  get(chains.denergy.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x63b92f7e2f69877184c955e63b9d8dff55e52e14", 696824],
  ...
  get(chains.gnosis.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xcd307b7ceb5a73c6d3c247d9aafc61851a6bedaf", 42386251],
  ...
  get(chains.hyperevm.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x17ccf6a73047eb6e477feb1d3bdac727425392a6", 15236266],
  ...
  get(chains.lightlink.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xb677dBC0d05b2d51C9A4c333d5d41e46ea3C9787", 167599942],
    ...
    [manifest.SABLIER_FACTORY_MERKLE_VCA]: ["0x6437ECad55D68BB4B3b53a9A330D6cd7Fa8e687c", 167601559],
  }),
  get(chains.linea.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xbc378d190647154e8b193505a5e575e28c132fe6", 23987894],
  ...
  get(chains.mainnet.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x7f70ba7c7373baa4047ce450168cd24968321bda", 23478565],
  ...
  get(chains.mode.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xc36ffed30c17f7b044975baee75ed41090df9d20", 29539361],
  ...
  get(chains.monad.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xaB15e653cD3bBCe7B7412f81056a450BC0f2e7B9", 34590049],
  ...
  get(chains.morph.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x39CBF38BDa1A629fcb17949cD7F8b2de2Bf6686b", 17414372],
  ...
  get(chains.optimism.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x2e0d590a0e48da5078c2a51d9638c6260a99915e", 141829590],
    ...
    [manifest.SABLIER_FACTORY_MERKLE_VCA]: ["0xaadd56cf2e781476fe49a8b36aeda84097b8f957", 141829590],
  }),
  get(chains.polygon.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x77efc83efdfc4fa4a0d9e6a535c2efe00bdaff62", 77100975],
  ...
  get(chains.scroll.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x29593be78eb8c0885a2ebcba4752574e48716eb4", 22280785],
  ...
  get(chains.sei.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xaea21609d62d58c8775d59ed584338b24bbc6eb2", 170944331],
    ...
    [manifest.SABLIER_FACTORY_MERKLE_VCA]: ["0x43da38c9a7fafe822465e023a75b85cf012b3f7a", 170944334],
  }),
  get(chains.sonic.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xc310f89972a576c3ec510c9a3265dea01a2fecdb", 48898081],
  ...
  get(chains.unichain.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x2f87acb56a7b1bf6ec76ac62c3880d87af025172", 28491280],
  ...
  get(chains.xdc.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x0543a1aa6abf1b5b69bfd159ebb4bcaaa7b27aa7", 94261051],
  ...
  get(chains.zksync.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x27e0076b5be25d604e201bb602d7713dcf267a30", 64987387],
...
export const testnets: Sablier.EVM.Deployment[] = [
  get(chains.arbitrumSepolia.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xea37da106ce1ad0264b20764824baca76bb88bd0", 199683214],
    ...
    [manifest.SABLIER_FACTORY_MERKLE_VCA]: ["0x686f70dfc05a52f2842b4a7f7963b3fa0f8f9a40", 199683225],
  }),
  get(chains.baseSepolia.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0xb04a60866516e335471b801a65812c1eb02fcc75", 31731891],
  ...
  get(chains.modeTestnet.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x05a666850b88a9b2f02ed851fee9a7ffc013deec", 35682183],
  ...
  get(chains.optimismSepolia.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x15917930cc30093823790c9d1f83d550c0de33d3", 33715307],
  ...
  get(chains.sepolia.id, {
    [manifest.SABLIER_FACTORY_MERKLE_INSTANT]: ["0x3633462151339dea950cBED2fd4d132Bd942b64b", 9311858],
