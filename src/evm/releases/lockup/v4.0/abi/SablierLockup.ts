export const sablierLockupAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        name: "unlockParams",
        type: "tuple",
        internalType: "struct LockupPriceGated.UnlockParams",
        components: [
  ...
  },
  {
    ...
    name: "getGranularity",
    inputs: [{ name: "streamId", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "granularity", type: "uint40", internalType: "uint40" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  {
    type: "function",
    name: "getPriceGatedUnlockParams",
    inputs: [{ name: "streamId", type: "uint256", internalType: "uint256" }],
    outputs: [
      {
        name: "unlockParams",
  ...
  },
  {
    ...
    inputs: [
      { name: "newNFTDescriptor", type: "address", internalType: "contract ILockupNFTDescriptor" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "granularity", type: "uint40", indexed: false, internalType: "uint40" },
      {
        name: "unlockAmounts",
        type: "tuple",
        indexed: false,
  ...
  {
    type: "event",
    name: "CreateLockupPriceGatedStream",
    inputs: [
      { name: "streamId", type: "uint256", indexed: true, internalType: "uint256" },
      {
        name: "oracle",
  ...
  {
    type: "error",
    name: "SablierLockup_WithdrawAmountNotEqualWithdrawableAmount",
    inputs: [
      { name: "streamId", type: "uint256", internalType: "uint256" },
      { name: "amount", type: "uint128", internalType: "uint128" },
      { name: "withdrawableAmount", type: "uint128", internalType: "uint128" },
