export const sablierBatchLockupAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "token", type: "address", internalType: "contract IERC20" },
      {
        name: "batch",
        type: "tuple[]",
        internalType: "struct BatchLockup.CreateWithTimestampsLPG[]",
        components: [
          { name: "sender", type: "address", internalType: "address" },
          { name: "recipient", type: "address", internalType: "address" },
          { name: "depositAmount", type: "uint128", internalType: "uint128" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "lockup", type: "address", indexed: true, internalType: "contract ISablierLockup" },
      { name: "streamIds", type: "uint256[]", indexed: false, internalType: "uint256[]" },
    ],
    anonymous: false,
  },
