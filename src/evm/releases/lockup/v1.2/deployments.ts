 ...
 */
export const mainnets: Sablier.EVM.Deployment.LockupV1[] = [
  ...
  get(chains.coreDao.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0xf0a7F2cCE911c298B5CB8106Db19EF1D00230710",
        18_995_887,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x98Fe0d8b2c2c05d9C6a9e635f59474Aaa0000120",
        18_995_887,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
        "0x9C99EF88399bC1c1188399B39E7Cc667D78210ea",
        18_995_887,
      ],
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0x074CC814a8114126c505F5eecFC82A400B39cA03",
        18_996_240,
      ],
    },
  }),
  ...
  get(chains.taiko.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0x238C830FA8E4ED0f0A4bc9C986BF338aEC9e38D1",
        262_694,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x5Ec0a2e88dAd09ad940Be2639c9aDb24D186989E",
        262_694,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0xd7df0b795756b60ab51a37e26f1edb7ef9e78828",
        262_734,
      ],
    },
  }),
 ...
 */
export const testnets: Sablier.EVM.Deployment.LockupV1[] = [
  get(chains.arbitrumSepolia.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0x8127E8081C22807c8a786Af1e1b174939577144A",
        64_010_288,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x9D1C257d9bc09E6E6B8E7e7c2496C12000f55457",
        64_010_292,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
        "0xaff2efFCF38Ea4A92E0cC5D7c48456C53358fE1a",
        64_010_295,
      ],
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0xa11561F9e418f2C431B411E1CA22FD3F85D4c831",
        64_013_228,
      ],
    },
  }),
  ...
  get(chains.lineaSepolia.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0x95D29708be647BDD8dA0bdF82B84eB5f42d45918",
        3_241_482,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x435F33C21B9Ea8BF207785616Bb28C46eDeD7366",
        3_241_482,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
  ...
  get(chains.optimismSepolia.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0x6CBe6e298A9354306e6ee65f63FF85CFA7062a39",
        14_622_635,
      ],
    },
  }),
  ...
  get(chains.taikoHekla.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0x01565a1298d631302c114E13C431c9345ae5532e",
        558_552,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x640376B26E5f57dCD385b394a24c91F4C60E4fAc",
        558_552,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0x4F0d64365EfA9D6D1B88FfC387Ce02e4A71d9f9f",
        566_058,
      ],
    },
  }),
  get(chains.zksyncSepolia.id, {
    core: {
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0xc4311a5913953162111bF75530f7BB14ec24e014",
        3_249_096,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
        "0x43864C567b89FA5fEE8010f92d4473Bf19169BBA",
        3_249_111,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_TRANCHED]: [
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_LOCKUP_FACTORY]: [
        "0x2CEf8C06dDF7a1440Ad2561c53821e43adDbfA31",
        3_250_862,
      ],
    },
  }),
