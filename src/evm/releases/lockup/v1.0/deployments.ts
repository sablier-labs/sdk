...
export const mainnets: Sablier.EVM.Deployment.LockupV1[] = [
  get(chains.arbitrum.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0x90cc23dc3e12e80f27c05b8137b5f0d2b1edfa20",
    },
  }),
  get(chains.avalanche.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0x817fE1364A9d57d1fB951945B53942234163Ef10",
    },
  }),
  get(chains.base.id, {
    core: {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0xf19576Ab425753816eCbF98aca8132A0f693aEc5",
    },
  }),
  get(chains.bsc.id, {
    core: {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0xc9bf2A6bD467A813908d836c1506efE61E465761",
    },
  }),
  get(chains.gnosis.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0x89AfE038714e547C29Fa881029DD4B5CFB008454",
    },
  }),
  get(chains.mainnet.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0x638a7aC8315767cEAfc57a6f5e3559454347C3f6",
    },
  }),
  get(chains.optimism.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0x8a6974c162fdc7Cb67996F7dB8bAAFb9a99566e0",
    },
  }),
  get(chains.polygon.id, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]:
        "0xccA6dd77bA2cfcccEdA01A82CB309e2A17901682",
    },
  }),
...
export const testnets: Sablier.EVM.Deployment.LockupV1[] = [
  get(chains.arbitrumSepolia.id, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: [
        "0x7938c18a59FaD2bA11426AcfBe8d74F0F598a4D2",
        2_838_657,
      ],
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: [
