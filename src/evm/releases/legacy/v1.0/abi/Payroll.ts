export const payrollAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: "sablier",
    outputs: [{ internalType: "contract Sablier", name: "", type: "address" }],
    payable: false,
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint256", name: "salaryId", type: "uint256" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "oldRelayHub", type: "address" },
      { indexed: true, internalType: "address", name: "newRelayHub", type: "address" },
    ],
