...
- **BREAKING**: Renamed `sablier.chains` → `sablier.evmChains`
- **BREAKING**: Renamed `sablier.contracts` → `sablier.evmContracts`
- **BREAKING**: Renamed `sablier.releases` → `sablier.evmReleases`
- **BREAKING**: Renamed `sablier.deployments` → `sablier.evmDeployments`
